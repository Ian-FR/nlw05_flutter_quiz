...
import 'package:flutter_dev_quiz/domain/entities/awnser.dart';
...
class AwnserWidget extends StatelessWidget {
  ...
  TextStyle get _selectedTextStyleCardRight =>
              ...
              children: [
                Expanded(
                    child: Text(awnser.title,
                        style: isSelected ? _selectedTextStyleCardRight : AppTextStyles.body)),
                Container(
                  width: 24,
                  height: 24,
                  decoration: BoxDecoration(
